...
SDE_CMD="$SDE_PATH/sde64 -mix -omix ${FILE_PREFIX}.mix -start_ssc_mark 1:10 -stop_ssc_mark 2:30 -pinlit2 -log:compressed gzip -log:mt 1 -log:basename ${FILE_PREFIX}.trace"
